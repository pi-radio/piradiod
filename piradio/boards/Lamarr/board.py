...
class Lamarr(CommandObject):
    def __init__(self):
        ...
        print("Programming LTC5584s...")
        self.children.LTC5584 = [ LTC5584Dev(spi_1V8.get_device(self.children.gpio[20+i])) for i in range(8) ]
        
        self.children.trigger = Trigger()

        print("Programming clock tree and LO...")

        self.mmlo_freq = GHz(17.3)
        ...
        self.children.lo_root = LMX2595Dev("LO Root", lmx_spi, f_src=MHz(40), A=self.mmlo_freq, B=self.NCO_freq, Apwr=15, Bpwr=15)
